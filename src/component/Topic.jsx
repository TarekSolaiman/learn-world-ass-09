      ...
      <div className="lg:flex items-center justify-center mx-5 lg:mx-20">
        ...
        <div className="text-lg lg:w-2/4 text-justify">
          <h1 className="text-2xl lg:text-4xl font-bold mb-2">
            <span className="text-4xl lg:text-6xl text-blue-400 font-bold">
              LEARN
            </span>{" "}
            World
          </h1>
          ...
          <div className="flex lg:justify-start justify-center">
            <Link to="/blog">
              <button className="mt-5 ml-2 lg:ml-10 border-2 border-blue-500 rounded-lg px-8 lg:px-12 py-2 hover:bg-blue-300 text-xl font-medium text-blue-400 hover:text-white">
                Blog
              </button>
            </Link>
